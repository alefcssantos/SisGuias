...
// Clients controller
$routes->get('/clientes', 'Clients::list');
$routes->get('/clientes(:any)', 'Clients::list/$1');

$routes->post('/clientes/cadastrar', 'Clients::create');
$routes->get('/clientes/excluir/(:num)', 'Clients::delete/$1');
// Products controller
